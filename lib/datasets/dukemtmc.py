...
class DukeMTMC(BaseDataset):
    def __init__(self,
        ...
        super(DukeMTMC, self).__init__(ignore_label, base_size,
        ...
        self.train_dir = os.path.join(self.root, 'dukemtmc', 'bounding_box_train')
        self.query_dir = os.path.join(self.root, 'dukemtmc', 'query')
        self.gallery_dir = os.path.join(self.root, 'dukemtmc', 'bounding_box_test')
